...
const textForPage3 = [
  ...
  '<span class="highlighted-text">Depolama ve Stok Yönetimi Depolama ve stok yönetimi</span> <br></br>Hizmetlerimiz, işletmenizin malzeme ve ürün stoklarını en verimli şekilde yönetmesine yardımcı olur. *Depolama ve stok yönetimi* çözümlerimiz, envanter takibi, depolama alanı optimizasyonu ve hızlı erişim sağlar. Kobinerji, depo yönetim sistemleri ile işletmenizin operasyonel verimliliğini artırır. ',
...
const textForPage4 = [
  '<span class="highlighted-text">Enerji Verimliliği Danışmanlık Hizmetleri</span> <br> Kobinerji, enerji verimliliği danışmanlık hizmetleri ile işletmenizin enerji tüketimini optimize eder ve maliyetleri düşürür. *Enerji verimliliği danışmanlık hizmetleri* kapsamında enerji etütleri, verimlilik artırıcı projeler (VAP) ve ISO 50001 enerji yönetim sistemleri kurulumu sunuyoruz. Uzman ekibimizle enerji tüketiminizi azaltarak, çevresel etkilerinizi en aza indiriyoruz.',
  ...
  '<span class="highlighted-text">Müşavir Mühendislik Danışmanlık Hizmetleri</span> <br></br>Müşavir mühendislik danışmanlık hizmetlerimiz ile projelerinizin her aşamasında yanınızdayız. *Müşavir mühendislik danışmanlık hizmetleri* kapsamında, projelerinizin planlama, tasarım, uygulama ve denetim süreçlerinde profesyonel danışmanlık sağlıyoruz. Kobinerji, projelerinizin sorunsuz ilerlemesi için gerekli teknik desteği sunar.',
  '<span class="highlighted-text">Yenilenebilir Enerji Proje Geliştirme</span> <br></br>Yenilenebilir enerji kaynaklarını kullanarak sürdürülebilir projeler geliştirmek istiyorsanız, Kobinerji sizinle. *Yenilenebilir enerji proje geliştirme* hizmetlerimiz, güneş, rüzgar, hidroelektrik ve biyokütle enerjisi projelerini kapsar. Uzman ekibimiz, projelerinizin her aşamasında yenilikçi ve çevre dostu çözümler sunar.',
  '<span class="highlighted-text">Endüstriyel Otomasyon ve Kontrol Sistemleri </span> <br></br>Kobinerji, endüstriyel otomasyon ve kontrol sistemleri ile üretim süreçlerinizi optimize eder. *Endüstriyel otomasyon ve kontrol sistemleri* hizmetlerimiz, üretim verimliliğini artırmak ve operasyonel maliyetleri düşürmek için en son teknolojileri kullanır. Otomasyon projelerinizde size özel çözümler sunarak, rekabet gücünüzü artırıyoruz.',
];

const textForPage5 = [
  '<span class="highlighted-text">İşe Alım ve Yerleştirme</span> <br></br> Kobinerji, işe alım ve yerleştirme hizmetleri ile işletmelerin en yetenekli adayları bulmalarını ve doğru pozisyonlara yerleştirmelerini sağlar. *İşe alım ve yerleştirme* süreçlerimiz, yetenek değerlendirme, mülakat ve seçim aşamalarını kapsar. Uzman ekibimiz, işletmenizin ihtiyaçlarına uygun adayları bulur ve işe alım sürecinizi hızlı ve etkili bir şekilde yönetir.',
  '<span class="highlighted-text">Performans Yönetimi ve Geliştirme </span> <br></br>Performans yönetimi ve geliştirme hizmetlerimiz, çalışanlarınızın performansını sürekli olarak izlemek ve geliştirmek için tasarlanmıştır. *Performans yönetimi ve geliştirme* kapsamında performans değerlendirme, geri bildirim ve kariyer gelişim planları sunuyoruz. Kobinerji, çalışanlarınızın potansiyelini en üst düzeye çıkarmak için gerekli desteği sağlar.',
  '<span class="highlighted-text">Eğitim ve Gelişim Programları</span> <br></br> Eğitim ve gelişim programlarımız, çalışanlarınızın yetkinliklerini artırmak ve profesyonel gelişimlerini desteklemek için tasarlanmıştır. *Eğitim ve gelişim programları* kapsamında, teknik eğitimler, liderlik geliştirme ve kişisel gelişim kursları sunuyoruz. Kobinerji, işletmenizin ihtiyaçlarına göre özelleştirilmiş eğitim çözümleri sağlar. ',
  '<span class="highlighted-text">İş Hukuku ve Mevzuat Danışmanlığı </span> <br></br>Kobinerji, iş hukuku ve mevzuat danışmanlığı hizmetleri ile işletmelerin yasal uyumluluklarını sağlamalarına yardımcı olur. *İş hukuku ve mevzuat danışmanlığı* kapsamında, iş sözleşmeleri, işçi hakları, iş güvenliği ve diğer yasal konularda profesyonel destek sunuyoruz. Uzman ekibimiz, işletmenizin yasal gerekliliklere uygun hareket etmesini sağlar.',
  '<span class="highlighted-text">Çalışan Memnuniyeti ve Motivasyon Yönetimi</span> <br></br> Çalışan memnuniyeti ve motivasyon yönetimi hizmetlerimiz, işletmenizin verimliliğini ve çalışan bağlılığını artırmak için tasarlanmıştır. *Çalışan memnuniyeti ve motivasyon yönetimi* kapsamında, anketler, geri bildirim sistemleri ve motivasyon artırıcı programlar sunuyoruz. Kobinerji, çalışanlarınızın memnuniyetini ve motivasyonunu en üst düzeye çıkarmak için çözümler geliştirir.',
];
...
//Create array of photos, for each textForPage . photosForPage1
